...
#define MQTT_HOST            "192.168.8.73" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "esp_mqtt_client"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "pi" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "hasson" // you MQTT login password, same as above
#define STA_SSID "Little"    // your AP/router SSID to config your device networking
#define STA_PASS "lrl1234567890" // your AP/router password
